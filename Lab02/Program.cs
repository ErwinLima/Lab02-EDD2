    ...
    public static void Main()
    {
        try
        {
            ...
            if (File.Exists(route))
            {
                ...
                foreach (var item in FileData)
                {
                    if (!string.IsNullOrEmpty(item))
                    {
                        ...
                        {
                            //Se crea un diccionario por cada empresa a la que este aplicando la persona
                            Dictionary<char, Letra> dictionario = new Dictionary<char, Letra>();
                            string codigo = persona.dpi + i.ToString(); //Se junta el dpi y el id de la compañía
            ...
            if (resultado != null)
            {
                ...
                {
                    case 1:                        
                        string output = @"C:\Users\AndresLima\Desktop\" + resultado.name + ".txt";
